...
function dataCouple() {
  ...
  document.getElementById('a0').innerText=coaches.itemListElement[1].item.name;
  document.getElementById('a0').href=coaches.itemListElement[1].item.url;
  document.getElementById('p2').innerText=coaches.itemListElement[2].position;
  document.getElementById('a0').innerText=coaches.itemListElement[2].item.name;
  document.getElementById('a0').href=coaches.itemListElement[2].item.url;
  document.getElementById('p3').innerText=coaches.itemListElement[3].position;
  document.getElementById('a0').innerText=coaches.itemListElement[3].item.name;
  document.getElementById('a0').href=coaches.itemListElement[3].item.url;
