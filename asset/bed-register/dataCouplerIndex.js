...
function dataCouple() {
  ...
  document.getElementById('a26').innerText=coaches.itemListElement[6].item.name;
  document.getElementById('a26').href=coaches.itemListElement[6].item.url;
  document.getElementById('p27').innerText=coaches.itemListElement[27].position;
  document.getElementById('a27').innerText=coaches.itemListElement[6].item.name;
  document.getElementById('a27').href=coaches.itemListElement[6].item.url;
