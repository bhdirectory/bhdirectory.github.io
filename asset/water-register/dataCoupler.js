...
function dataCouple() {
  ...
  document.getElementById('mailtoPass').href="mailto:maintenance@birtleyhouse.co.uk?subject=TMV%20Check%20PASS%20" + coaches.identifier + "&body=No%20action%20required";
  document.getElementById('mailtoFail').href="mailto:maintenance@birtleyhouse.co.uk?subject=TMV%20Check%20FAIL%20" + coaches.identifier + "&body=Reason%20for%20failure:&20";
}
