...
function dataCouple() {
  ...
  document.getElementById('p2').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p3').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p4').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p5').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p6').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p7').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p8').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p9').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p10').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p11').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p12').innerText=coaches.itemListElement[0].position;
  ...
  document.getElementById('p13').innerText=coaches.itemListElement[0].position;
